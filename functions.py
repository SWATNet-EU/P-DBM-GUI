...
def PDBM(r0, dr0, r1, v0, dv0, gamma_array, wind_array, dt0, N):
    r0_array = np.random.normal(r0, dr0, N)
    v0_array = np.random.normal(v0, dv0, N)
    r1_array = np.random.normal(r1, 0.05*r1, N)
    t0_array = np.random.normal(0, dt0/3600.0, N)
