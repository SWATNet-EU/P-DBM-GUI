...
def display():
    ...
    dt0, dr0, dv0, dw, dgamma, w, gamma, solar_wind = (
        None,
        None,
        None,
        None,
        ...
        with st.container():
            ...
            with row2_col2:
                cme_hour = st.selectbox(
                    "", options=list(range(0, 24)), index=12, help="CME hour"
                )
            with row2_col3:
                cme_min = st.selectbox(
                    "", options=list(range(0, 60)), index=0, help="CME minute"
                )
            ...
            with row4_col2:
                v0 = st.number_input(
                    "", key="v0", value=1000.0, label_visibility="collapsed"
                )
            if pdbm == "Yes":
                with row4_col3:
                    dv0 = st.number_input(
